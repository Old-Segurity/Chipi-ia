...
class AppConfig:
    ...
    APP_NAME = "OLD-SECURITY Chipi IA"
    APP_VERSION = "2.1.0"
    ...
    API_MODEL = "google/gemini-flash-1.5"
    API_TIMEOUT = 10
    API_MAX_TOKENS = 250
    API_TEMPERATURE = 0.3

    # Configuración de audio
    AUDIO_ENABLED = False  # Desactivado en versión web
    AUDIO_MIN_LENGTH = 30
    ...
    def get_api_key(cls) -> Optional[str]:
        ...
        # En Render, las variables de entorno se configuran en el dashboard
